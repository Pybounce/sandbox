...
const JsNativeFnFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_jsnativefn_free(ptr >>> 0, 1));
...
export class CompilerErr {
    ...
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        CompilerErrFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_compilererr_free(ptr, 0);
    }
    /**
     * @returns {number}
     */
    get line() {
        const ret = wasm.__wbg_get_compilererr_line(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @param {number} arg0
     */
    set line(arg0) {
        wasm.__wbg_set_compilererr_line(this.__wbg_ptr, arg0);
    }
    /**
     * @returns {number}
     */
    get start() {
        const ret = wasm.__wbg_get_compilererr_start(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @param {number} arg0
     */
    set start(arg0) {
        wasm.__wbg_set_compilererr_start(this.__wbg_ptr, arg0);
    }
    /**
     * @returns {number}
     */
    get len() {
        const ret = wasm.__wbg_get_compilererr_len(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @param {number} arg0
...
export class JsNativeFn {
    static __unwrap(jsValue) {
        if (!(jsValue instanceof JsNativeFn)) {
            return 0;
        }
    ...
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        JsNativeFnFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_jsnativefn_unwrap = function(arg0) {
        const ret = JsNativeFn.__unwrap(arg0);
        return ret;
    };
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('bytecode_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
